...
cd ../../k8s
sed -i "s|image: your-registry/tfg-backend:latest|image: gcr.io/${PROJECT_ID}/tfg-backend:latest|g" backend-deployment.yaml
...
cd ../../k8s
sed -i "s|image: your-registry/tfg-frontend:latest|image: gcr.io/${PROJECT_ID}/tfg-frontend:latest|g" frontend-deployment.yaml
